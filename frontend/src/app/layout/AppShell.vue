...
const accountInspectionMenuItems = computed<MenuOption[]>(() => [
  ...
  { label: t('插件监控日志', 'Plugin Event Log'), key: '/admin/plugin-events', icon: renderIcon(ScrollText) },
...
const accountMenuItems = computed<MenuOption[]>(() => [
  ...
  { label: t('CPA OAuth 登录', 'CPA OAuth Login'), key: '/account/cpa-oauth', icon: renderIcon(LogIn) },
